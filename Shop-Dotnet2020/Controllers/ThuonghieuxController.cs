...
namespace Shop_Dotnet2020.Controllers
{
    ...
    public class ThuonghieuxController : ControllerBase
    {
        ...
        {
            return await _context.Thuonghieux.Include(th => th.Sanphams).ToListAsync();
        }
        ...
        {
            var thuonghieu = await _context.Thuonghieux.Include(th => th.Sanphams)
               .Where(th => th.Idth == id)
               .FirstOrDefaultAsync(); 
        ...
        {
            return _context.Thuonghieux.Any(e => e.Idth == id);
        }
    }
}
